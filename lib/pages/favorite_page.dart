                        ...
                        children: [
                          ...
                          Wrap(
                            ...
                            children: List.generate(favoriteValkyries.length, (
                              ...
                              final String name = favoriteValkyries[index].name;
                              final List equipment =
                                  favoriteValkyries[index].equipment;
                              final List note = favoriteValkyries[index].note;
                              final List leader =
                              ...
                              (index) {
                                final WeatherModel weather =
                                    weathers
                                        ...
                                        .toList()[0];
                                final String id = favoriteAbyssBosses[index].id;
                                final String name =
                                ...
                                final List elf = favoriteAbyssBosses[index].elf;
                                final List note =
                        ...
                        children: [
                          ...
                          Wrap(
                            ...
                            children: List.generate(
                              ...
                              (index) {
                                final String id = favoriteArenaBosses[index].id;
                                final String name =
                                ...
                                final List elf = favoriteArenaBosses[index].elf;
                                return SizedBox(
                                  width: 200,
