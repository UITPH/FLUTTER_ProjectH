...
class DeleteArenaBossPage extends ConsumerStatefulWidget {
  const DeleteArenaBossPage({super.key});

  @override
  ConsumerState<DeleteArenaBossPage> createState() =>
      _DeleteArenaBossPageState();
}
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('Delete Arena Boss Page'),
      ),
      body: SafeArea(
        child: Center(
          child: SizedBox(
                  ...
                  child: Padding(
                    ...
                    child: GridView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return AdvanceArenabossCard(id: id, name: name);
                      },
                    ),
                  ),
                ),
