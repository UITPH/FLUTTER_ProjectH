...
import 'package:flutter_honkai/widgets/modify_valk_card.dart';
...
class ModifyValkyriePage extends ConsumerStatefulWidget {
  const ModifyValkyriePage({super.key});

  @override
  ConsumerState<ModifyValkyriePage> createState() => _ModifyValkyriePageState();
}

class _ModifyValkyriePageState extends ConsumerState<ModifyValkyriePage> {
                ...
                Expanded(
                  child: GridView.builder(
                    ...
                    itemBuilder: (context, index) {
                      return ModifyValkCard(valk: filteredValkyries[index]);
                    },
                  ),
                ),
              ],
